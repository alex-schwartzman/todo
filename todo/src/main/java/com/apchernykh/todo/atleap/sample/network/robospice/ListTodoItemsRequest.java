...
public class ListTodoItemsRequest extends BaseRequest<Item.ItemsResult, TodoApiService> {


    public ListTodoItemsRequest() {
        super(Item.ItemsResult.class, TodoApiService.class);
    }

    @Override
    public Item.ItemsResult loadDataFromNetwork() {
