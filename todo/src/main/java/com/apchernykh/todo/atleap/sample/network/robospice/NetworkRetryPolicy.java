...
import com.apchernykh.todo.atleap.sample.exception.UnauthorizedException;
...
class NetworkRetryPolicy implements RetryPolicy {
    ...
    private static final long DEFAULT_DELAY_BEFORE_RETRY = 2500;
    ...
    private NetworkRetryPolicy(int retryCount, long delayBeforeRetry, float backOffMultiplier) {
